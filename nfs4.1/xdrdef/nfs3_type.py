...
class post_op_attr:
    ...
    switch = property(lambda s: {const.TRUE:s.attributes,const.FALSE:None,}[s.attributes_follow])
...
class post_op_fh3:
    ...
    switch = property(lambda s: {const.TRUE:s.handle,const.FALSE:None,}[s.handle_follows])
...
class set_mode3:
    ...
    switch = property(lambda s: {const.TRUE:s.mode,}.get(s.set_it, None))
...
class set_uid3:
    ...
    switch = property(lambda s: {const.TRUE:s.uid,}.get(s.set_it, None))
...
class set_gid3:
    ...
    switch = property(lambda s: {const.TRUE:s.gid,}.get(s.set_it, None))
...
class set_size3:
    ...
    switch = property(lambda s: {const.TRUE:s.size,}.get(s.set_it, None))
...
class set_atime:
    ...
    switch = property(lambda s: {const.SET_TO_CLIENT_TIME:s.atime,}.get(s.set_it, None))
...
class set_mtime:
    ...
    switch = property(lambda s: {const.SET_TO_CLIENT_TIME:s.mtime,}.get(s.set_it, None))
...
class GETATTR3res:
    ...
    switch = property(lambda s: {const.NFS3_OK:s.resok,}.get(s.status, None))
...
class sattrguard3:
    ...
    switch = property(lambda s: {const.TRUE:s.obj_ctime,const.FALSE:None,}[s.check])
...
class SETATTR3resok:
    ...
    def __getattr__(self, attr):
        return getattr(self.obj_wcc, attr)
...
class LOOKUP3resfail:
    ...
    def __getattr__(self, attr):
        return getattr(self.dir_attributes, attr)
...
class READLINK3args:
    ...
    def __getattr__(self, attr):
        return getattr(self.symlink, attr)
...
class CREATE3resfail:
    ...
    def __getattr__(self, attr):
        return getattr(self.dir_wcc, attr)
...
class RENAME3args:
    ...
    #     diropargs3 tofile;
    # };
    def __init__(self, fromfile=None, tofile=None):
    ...
    def __repr__(self):
        ...
        if self.fromfile is not None:
            out += ['fromfile=%s' % repr(self.fromfile)]
        if self.tofile is not None:
            out += ['tofile=%s' % repr(self.tofile)]
...
class FSSTAT3args:
    ...
    def __getattr__(self, attr):
        return getattr(self.fsroot, attr)
